        ...
        if(renderLayer == 1) {
            ...
            if (isMoving) {
                ...
                if (System.currentTimeMillis() % cycle < cycle / 4 * 1) {
                    gc.drawImage(TestRenderHelper.resample(sprites.get(id + 0), 2), (int) (x * World.getScaledUpSquareSize() + 1.5), (int) (y * World.getScaledUpSquareSize() + 0.5) - (World.getScaledUpSquareSize() * 2 - sprites.get(0).getHeight()));
                } else {
                    if (System.currentTimeMillis() % cycle < cycle / 4 * 2) {
                        gc.drawImage(TestRenderHelper.resample(sprites.get(id + 1), 2), (int) (x * World.getScaledUpSquareSize() + 1.5), (int) (y * World.getScaledUpSquareSize() + 0.5) - (World.getScaledUpSquareSize() * 2 - sprites.get(0).getHeight()));
                        ...
                        if (System.currentTimeMillis() % cycle < cycle / 4 * 3) {
                            ...
                            gc.drawImage(TestRenderHelper.resample(sprites.get(id + 2), 2), (int) (x * World.getScaledUpSquareSize() + 1.5), (int) (y * World.getScaledUpSquareSize() + 0.5) - (World.getScaledUpSquareSize() * 2 - sprites.get(0).getHeight()));
