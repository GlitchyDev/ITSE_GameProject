...
public class CreditGameState extends GameStateBase {
    ...
    protected void doRender(Canvas canvas, GraphicsContext gc) {
        ...
        int xOffset = (int)(Math.sin(Math.PI * progress + Math.PI/5.0*1) * 10.0);
        gc.drawImage(globalGameData.getSprite("Robert"),offset + xOffset,80);
        xOffset = (int)(Math.sin(Math.PI * progress + Math.PI/5.0*2) * 10.0);
        gc.drawImage(globalGameData.getSprite("Charlie"),offset + xOffset,180);
        xOffset = (int)(Math.sin(Math.PI * progress + Math.PI/5.0*3) * 10.0);
        gc.drawImage(globalGameData.getSprite("Ben"),offset + xOffset, 280);
        xOffset = (int)(Math.sin(Math.PI * progress + Math.PI/5.0*4) * 10.0);
        gc.drawImage(globalGameData.getSprite("Abdu"),offset + xOffset,380);
        xOffset = (int)(Math.sin(Math.PI * progress + Math.PI/5.0*5) * 10.0);
        gc.drawImage(globalGameData.getSprite("Tanner"),offset + xOffset,480);
